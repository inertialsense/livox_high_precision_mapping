...
void uINS::openLogParsedDataFile(void)
{
    //pFile = fopen ("myfile.txt","w");
}

/**********************************************************************/
U32 uINS::getU32(unsigned char * * ppData)
/**********************************************************************/
...
/**********************************************************************/
float uINS::getFloat(unsigned char * * ppData)
/**********************************************************************/
// Used by the decoding routines to grab 4 bytes and pack them into
...
/**********************************************************************/
double uINS::getDouble(unsigned char * * ppData)
/**********************************************************************/
...
/**********************************************************************/
unsigned short uINS::getU16(unsigned char * * ppData)
/**********************************************************************/
...
/**********************************************************************/
S16 uINS::getS16(unsigned char * * ppData)
/**********************************************************************/
// Used by the decoding routines to grab 2 bytes and pack them into
...
/**********************************************************************/
S32 uINS::getS32(unsigned char * * ppData)
/**********************************************************************/
// Used by the decoding routines to grab 4 bytes and pack them into
...
/**********************************************************************/
void uINS::processEventMarker(int length, unsigned char *pData)
/**********************************************************************/
{
...
/**********************************************************************/
void uINS::processINSNavigationInfo(int length, unsigned char *pData)
/**********************************************************************/
...
/**********************************************************************/
void uINS::processINSRMSInfo(int length, unsigned char *pData)
/**********************************************************************/
...
/**********************************************************************/
void uINS::processUTC(int length, unsigned char *pData)
/**********************************************************************/
...
/**********************************************************************/
void uINS::processGsofData(void)
/**********************************************************************/
...
/**********************************************************************/
void uINS::postGsofData(unsigned char * pData, int length)
/**********************************************************************/
...
unsigned char uINS::grabGsof(unsigned char * pData, int length)
{
  static int tcStx;
  static int tcStat;
  static int tcType;
