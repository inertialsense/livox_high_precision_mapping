...
{
  public: 
  uinsRosDriver(std::string port, int32_t baud, ros::NodeHandle* gnss_inertial_nh);
  ~uinsRosDriver();
  ...
  void publishMsgs(uINS::uINS& myApx15Gsof, ros::NodeHandle* gnss_inertial_nh);
  
  uint32_t utc_offset_second;
  void recordOffsetTime(uINS::uINS& myApx15Gsof);

};


uinsRosDriver::uinsRosDriver(std::string port, int32_t baud, ros::NodeHandle* gnss_inertial_nh)
{
...
void uinsRosDriver::recordOffsetTime(uINS::uINS& myApx15Gsof)
{
...
void uinsRosDriver::publishMsgs(uINS::uINS& myApx15Gsof, ros::NodeHandle* gnss_inertial_nh)
{
...
{
  ros::init(argc, argv, "uINS_gsof_driver");
  ...
  uinsRosDriver myuinsRosDriver(port, baud, &gnss_inertial_nh);
